...
export default function CardLanding({title, paragraph}: CardLandingProps) {
	return (
		<div className=" inline-flex justify-start items-start p-5 bg-white w-full rounded-[25px] text-black flex flex-col gap-2 md:p-[30px] md:gap-4 md:rounded-[30px]  xl:w-[500px]">
